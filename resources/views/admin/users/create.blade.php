<x-admin-layout>
    ...
    <div class="max-w-lg">
        <div class="flex items-center gap-2 mb-5">
            ...
            <span class="text-sm font-medium text-gray-900 dark:text-white">Tambah Pengguna</span>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST"
            ...
            <div>
                <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">Password <span class="text-red-500">*</span></label>
