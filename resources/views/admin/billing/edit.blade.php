<x-admin-layout>
    ...
    <div class="max-w-2xl">
        <div class="flex items-center gap-2 mb-5">
            ...
            <span class="text-sm font-medium text-gray-900 dark:text-white">Edit Paket: {{ $billing->nama }}</span>
        </div>

        <form action="{{ route('admin.billing.update', $billing) }}" method="POST"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $billing->nama) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug', $billing->slug) }}" required
                        class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="harga" value="{{ old('harga', $billing->harga) }}" min="0" required
                        class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                ...
                <div>
                    ...
                    <input type="number" name="durasi_hari" value="{{ old('durasi_hari', $billing->durasi_hari) }}" min="1" required
                        class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                ...
                <div>
                    ...
                    <input type="number" name="urutan" value="{{ old('urutan', $billing->urutan) }}" min="0"
                        class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
            ...
            <div>
                ...
                <input type="number" name="batas_laporan_per_bulan" value="{{ old('batas_laporan_per_bulan', $billing->batas_laporan_per_bulan) }}" min="1"
            ...
            <div>
                ...
                <textarea name="fitur" rows="5"
                    class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none">{{ old('fitur', implode("\n", $billing->fitur ?? [])) }}</textarea>
                @error('fitur') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
            </div>

            <div class="flex items-center gap-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_trial" value="1" {{ old('is_trial', $billing->is_trial) ? 'checked' : '' }}
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $billing->is_active) ? 'checked' : '' }}
                        class="w-4 h-4 rounded border-gray-300 dark:border-gray-700 text-blue-600 focus:ring-blue-500">
