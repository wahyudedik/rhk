<x-admin-layout>
    <x-slot name="title">Tambah Jenis RHK</x-slot>
    ...
    <div class="max-w-lg">
        <div class="flex items-center gap-2 mb-5">
            ...
            <span class="text-sm font-medium text-gray-900 dark:text-white">Tambah Jenis RHK</span>
        </div>
        ...
        <div class="mb-4 p-3.5 bg-blue-50 dark:bg-blue-950 rounded-xl border border-blue-200 dark:border-blue-800 text-sm text-blue-800 dark:text-blue-300">
            <span class="font-medium">RHK:</span> {{ Str::limit($rhk->nama, 80) }}
        </div>

        <form action="{{ route('admin.rhk.jenis-rhk.store', $rhk) }}" method="POST"
            ...
            <div>
                ...
                <textarea name="nama" rows="3" required
                    ...
                    placeholder="Nama jenis RHK...">{{ old('nama') }}</textarea>
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit"
                    class="px-4 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition">Simpan</button>
            </div>
        </form>
    </div>
</x-admin-layout>
