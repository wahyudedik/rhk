...
class UpdateLaporanRequest extends FormRequest
{
    ...
    {
        return true; // Otorisasi ditangani oleh LaporanPolicy via $this->authorize() di controller
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'ttd_gambar_canvas' => ['nullable', 'string'],
            // Dokumentasi
            'foto_dokumentasi.*' => ['nullable', 'file', 'mimes:jpg,jpeg,png', 'max:5120'],
            'foto_dokumentasi_existing' => ['nullable', 'string'], // JSON existing paths
